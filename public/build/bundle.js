...
var _Invention = __webpack_require__(86);

var _Invention2 = _interopRequireDefault(_Invention);
...
var Details = function (_Component) {
    ...
    _createClass(Details, [{
        ...
        value: function render() {
            var style = _styles2.default.detail;
            var listItems = this.props.Inventionslist.map(function (invention, i) {
                return _react2.default.createElement(
                    'li',
                    { key: i },
                    _react2.default.createElement(_Invention2.default, { inventionDetails: invention })
                );
            });
...
var ReactCurrentOwner = __webpack_require__(326);
...
var ReactNoopUpdateQueue = __webpack_require__(330);

var canDefineProperty = __webpack_require__(325);
var emptyObject = __webpack_require__(29);
var invariant = __webpack_require__(23);
var lowPriorityWarning = __webpack_require__(327);
...
var ReactCurrentOwner = __webpack_require__(326);
var ReactComponentTreeHook = __webpack_require__(328);
var ReactElement = __webpack_require__(323);
...
var createReactClass = __webpack_require__(347);
...
if (process.env.NODE_ENV !== 'production') {
  var lowPriorityWarning = __webpack_require__(327);
  var canDefineProperty = __webpack_require__(325);
  var ReactElementValidator = __webpack_require__(333);
...
if (typeof process !== 'undefined' && process.env && process.env.NODE_ENV === 'test') {
  ...
  ReactComponentTreeHook = __webpack_require__(328);
}
...
var m=__webpack_require__(22),n=__webpack_require__(29),p=__webpack_require__(11),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(49),B=__webpack_require__(22),C=__webpack_require__(11),ba=__webpack_require__(50),da=__webpack_require__(51),ea=__webpack_require__(52),fa=__webpack_require__(53),ia=__webpack_require__(54),D=__webpack_require__(29);
...
var _Inventions = __webpack_require__(85);

var _Inventions2 = _interopRequireDefault(_Inventions);

var _Details = __webpack_require__(149);
...
var Home = function (_Component) {
    ...
    _createClass(Home, [{
        ...
        value: function componentDidMount() {
            ...
            _utils.APIManager.get("/api/invention/list", null, function (err, results) {
                if (err) {
                    alert("ERROR: " + err.message);
                    return;
                }

                results.map(function (inventions) {
        ...
        key: 'callbackList',
        value: function callbackList(updatedData) {
            var _this3 = this;

            _utils.APIManager.post("/api/invention/create", updatedData, function (err, results) {
                if (err) {
                    alert("ERROR: " + err.message);
                    return;
                }
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'container', style: _styles2.default.home },
                _react2.default.createElement(
                    'div',
                    { className: 'row' },
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-4' },
                        _react2.default.createElement(_Inventions2.default, { callbackList: this.callbackList.bind(this) })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-8' },
                        _react2.default.createElement(_Details2.default, { Inventionslist: this.state.list })
                    )
                )
            );
        }
...
var _reactCurrencyMaskedInput = __webpack_require__(334);

var _reactCurrencyMaskedInput2 = _interopRequireDefault(_reactCurrencyMaskedInput);
...
var Inventions = function (_Component) {
    _inherits(Inventions, _Component);

    function Inventions() {
        _classCallCheck(this, Inventions);

        var _this = _possibleConstructorReturn(this, (Inventions.__proto__ || Object.getPrototypeOf(Inventions)).call(this));
    ...
    _createClass(Inventions, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            var _this2 = this;

            _utils.APIManager.get("/api/categories/list", null, function (err, results) {
                if (err) {
                    alert("ERROR: " + err.message);
                    return;
                }
        ...
        key: "addInvention",
        value: function addInvention() {
            if (!this.state.invention.name || !this.state.invention.description || !this.state.invention.price) {
        ...
        key: "render",
        value: function render() {
            var listCategories = this.state.categories.map(function (category, i) {
                return _react2.default.createElement(
                    "option",
            ...
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("input", { id: "name", onChange: this.updateInvention.bind(this), className: "form-control", type: "text", placeholder: "Name" }),
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { id: "description", onChange: this.updateInvention.bind(this), className: "form-control", type: "text", placeholder: "Description" }),
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { id: "quantity", onChange: this.updateInvention.bind(this), className: "form-control", type: "number", step: 1, min: 0, placeholder: "Quantity" }),
                _react2.default.createElement("br", null),
                _react2.default.createElement(_reactCurrencyMaskedInput2.default, { id: "price", onChange: this.updateInvention.bind(this), className: "form-control", placeholder: "Price" }),
                _react2.default.createElement("br", null),
                _react2.default.createElement(_reactCurrencyMaskedInput2.default, { id: "discountPrice", onChange: this.updateInvention.bind(this), className: "form-control", type: "number", placeholder: "Discount" }),
                _react2.default.createElement("br", null),
                _react2.default.createElement(
                    "select",
                    { value: this.state.invention.categoryId, onChange: this.updateCategory.bind(this), className: "form-control" },
                    listCategories
                ),
                _react2.default.createElement("br", null),
                _react2.default.createElement(
                    "button",
                    { onClick: this.addInvention.bind(this), className: "btn btn-danger" },
                    "Add Invention"
                )
            );
        }
...
var Invention = function (_Component) {
    _inherits(Invention, _Component);

    function Invention() {
        _classCallCheck(this, Invention);

        return _possibleConstructorReturn(this, (Invention.__proto__ || Object.getPrototypeOf(Invention)).apply(this, arguments));
    }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.props.inventionDetails.name
                    )
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            { className: 'detail' },
                            this.props.inventionDetails.description
                        ),
                        _react2.default.createElement('br', null),
                        _react2.default.createElement(
                            'span',
                            { className: 'detail' },
                            ' ',
                            this.props.inventionDetails.categoryName
                        ),
                        _react2.default.createElement('br', null),
                        _react2.default.createElement(
                            'span',
                            { className: 'detail' },
                            ' R$ ',
                            this.props.inventionDetails.price
                        ),
                        _react2.default.createElement('br', null),
                        _react2.default.createElement(
                            'span',
                            { className: 'detail' },
                            ' R$ ',
                            this.props.inventionDetails.discountPrice
                        ),
                        _react2.default.createElement('br', null),
                        _react2.default.createElement(
                            'span',
...
var _APIManager = __webpack_require__(89);
