...
routes.route('/:orderNumber/refuse')
  ...
  .post((request, response) => {
    courier.pickUp.refuse(request.body, request.decoded)
      .then(success(response))
      .catch(fail(response))
  })
...
routes.route('/:orderNumber/accept')
  .all(auth)
  .post((request, response) => {
    courier.pickUp.accept(request.body, request.decoded)
      .then(success(response))
      .catch(fail(response))
  })
...
routes.route('/:orderNumber/success')
  .all(auth)
  .post((request, response) => {
    courier.pickUp.success(request.body, request.decoded)
      .then(success(response))
      .catch(fail(response))
  })
...
routes.route('/:orderNumber/problem')
  .all(auth)
  .post((request, response) => {
    courier.pickUp.problem(request.body, request.decoded)
      .then(success(response))
      .catch(fail(response))
  })
