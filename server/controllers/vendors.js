  ...
  return new Promise(function (resolve, reject) {
    ...
    cedCsmarketplaceVendor.create({
      ...
      return Promise.all([
        ...
        cedCsmarketplaceVendorVarchar.create(entity(null, NAME, 0, vendor.null, data.firstname)),
...
function updateMarketplaceVendor (data, vendorId) {
  return new Promise(function (resolve, reject) {
    return Promise.all([
      ...
      cedCsmarketplaceVendorVarchar.update({ value: data.firstname }, { where: entity(null, NAME, 0, vendorId, null) }),
